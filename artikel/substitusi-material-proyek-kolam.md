---
article_id: KKP-12-A03
title: "Menilai Material Alternatif dan Substitusi pada Proyek Kolam"
slug: "substitusi-material-proyek-kolam"
description: "Compare function, performance, compatibility, durability, maintenance, evidence, warranty, schedule, cost, and downstream impacts"
status: outline
publication_date: "2026-02-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-12
primary_intent: "Evaluate proposed changes"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Teman Kontraktorkolam.co.id"
final_route: "/artikel/substitusi-material-proyek-kolam.html"
...
# Menilai Material Alternatif dan Substitusi pada Proyek Kolam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Menilai Material Alternatif dan Substitusi pada Proyek Kolam”
- **Reader and situation:** Team facing availability/cost changes
- **Reader outcome:** Compare function, performance, compatibility, durability, maintenance, evidence, warranty, schedule, cost, and downstream impacts
- **Primary intent:** Evaluate proposed changes
...
- **Scope boundary:** No equivalence claim without project approval
- **Final public route:** `/artikel/substitusi-material-proyek-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menilai Material Alternatif dan Substitusi pada Proyek Kolam**.
...
- `KKP-12-A01` → `/artikel/submittal-equipment-kolam.html` — Submittal Equipment Kolam: Data yang Harus Dicek
- `KKP-12-A02` → `/artikel/material-approval-proyek-kolam.html` — Material Approval untuk Struktur, Waterproofing, dan Finishing Kolam
- `KKP-12-A04` → `/artikel/long-lead-items-proyek-kolam.html` — Long-Lead Items Kolam dan Procurement Schedule
- `KKP-12-A05` → `/artikel/receiving-storage-equipment-kolam.html` — Receiving, Storage, dan Preservation Equipment Kolam
...
- **Tie back to this article:** Keep the explanation specific to “Menilai Material Alternatif dan Substitusi pada Proyek Kolam”.
