---
article_id: KKP-03-A02
title: "Peran Arsitek, Struktur, MEP, dan Kontraktor Kolam"
slug: "peran-tim-proyek-kolam"
description: "Define deliverables and decision boundaries across owner, architect, engineers, pool specialist, landscape, operator"
status: outline
...
final_route: "/artikel/peran-tim-proyek-kolam.html"
...
# Peran Arsitek, Struktur, MEP, dan Kontraktor Kolam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Peran Arsitek, Struktur, MEP, dan Kontraktor Kolam”
- **Reader and situation:** Multi-party project team
- **Reader outcome:** Define deliverables and decision boundaries across owner, architect, engineers, pool specialist, landscape, operator
...
- **Scope boundary:** Does not certify qualifications or contract liability
- **Final public route:** `/artikel/peran-tim-proyek-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Peran Arsitek, Struktur, MEP, dan Kontraktor Kolam**.
...
- `KKP-03-A03` → `/artikel/scope-matrix-proyek-kolam.html` — Membuat Scope Matrix agar Pekerjaan Kolam Tidak Terlewat
...
- **Tie back to this article:** Keep the explanation specific to “Peran Arsitek, Struktur, MEP, dan Kontraktor Kolam”.
