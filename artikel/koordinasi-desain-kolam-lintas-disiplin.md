---
article_id: KKP-04-A03
title: "Koordinasi Level, Penetrasi, Plant Room, dan Landscape"
slug: "koordinasi-desain-kolam-lintas-disiplin"
description: "Coordinate finished water/deck levels, structure, pipe sleeves, drainage, equipment access, power, and planting"
status: outline
publication_date: "2025-08-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-04
primary_intent: "Prevent clashes"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Teman Kontraktorkolam.co.id"
final_route: "/artikel/koordinasi-desain-kolam-lintas-disiplin.html"
...
# Koordinasi Level, Penetrasi, Plant Room, dan Landscape

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Level, Penetrasi, Plant Room, dan Landscape”
- **Reader and situation:** Architect/contractor before construction
- **Reader outcome:** Coordinate finished water/deck levels, structure, pipe sleeves, drainage, equipment access, power, and planting
- **Primary intent:** Prevent clashes
...
- **Scope boundary:** Field changes belong to KKP-13
- **Final public route:** `/artikel/koordinasi-desain-kolam-lintas-disiplin.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Level, Penetrasi, Plant Room, dan Landscape**.
...
- `KKP-04-A01` → `/artikel/daftar-gambar-proyek-kolam.html` — Daftar Gambar Proyek Kolam dari Konsep sampai IFC
- `KKP-04-A02` → `/artikel/design-basis-proyek-kolam.html` — Design Basis Kolam: Dokumen yang Menjelaskan Alasan di Balik Gambar
- `KKP-04-A04` → `/artikel/review-constructability-desain-kolam.html` — Review Constructability Desain Kolam Sebelum Tender
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Level, Penetrasi, Plant Room, dan Landscape”.
