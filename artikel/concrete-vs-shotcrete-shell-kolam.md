---
article_id: KKP-07-A04
title: "Concrete atau Shotcrete untuk Shell Kolam: Kontrol Mutu Pelaksanaan"
slug: "concrete-vs-shotcrete-shell-kolam"
description: "Compare design dependence, batching, placement, compaction/nozzle skill, rebound, joints, curing, tests, and records"
status: outline
publication_date: "2025-10-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-07
primary_intent: "Compare execution controls"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Teman Kontraktorkolam.co.id"
final_route: "/artikel/concrete-vs-shotcrete-shell-kolam.html"
...
# Concrete atau Shotcrete untuk Shell Kolam: Kontrol Mutu Pelaksanaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Concrete atau Shotcrete untuk Shell Kolam: Kontrol Mutu Pelaksanaan”
- **Reader and situation:** Owner evaluating method proposals
- **Reader outcome:** Compare design dependence, batching, placement, compaction/nozzle skill, rebound, joints, curing, tests, and records
- **Primary intent:** Compare execution controls
...
- **Scope boundary:** Not mixture design or nozzle instruction
- **Final public route:** `/artikel/concrete-vs-shotcrete-shell-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Concrete atau Shotcrete untuk Shell Kolam: Kontrol Mutu Pelaksanaan**.
...
- `KKP-07-A02` → `/artikel/excavation-shoring-dewatering-kolam.html` — Excavation, Shoring, dan Dewatering: Data Sebelum Metode Kerja
- `KKP-07-A03` → `/artikel/pemeriksaan-sebelum-cor-kolam.html` — Pemeriksaan Tulangan, Embedment, dan Penetrasi sebelum Pengecoran
- `KKP-07-A05` → `/artikel/curing-retak-awal-struktur-kolam.html` — Curing, Retak Awal, dan Kapan Struktur Kolam Boleh Dilanjutkan
- `KKP-07-A06` → `/artikel/pelaksanaan-kolam-rooftop.html` — Kolam Rooftop: Interface Struktur, Gerakan, dan Akses Konstruksi
...
- **Tie back to this article:** Keep the explanation specific to “Concrete atau Shotcrete untuk Shell Kolam: Kontrol Mutu Pelaksanaan”.
