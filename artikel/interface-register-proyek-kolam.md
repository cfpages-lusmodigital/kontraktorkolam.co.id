---
article_id: KKP-03-A04
title: "Interface Register: Siapa Mengerjakan Penetrasi, Drainase, dan Power?"
slug: "interface-register-proyek-kolam"
description: "Track each boundary, input, owner, due date, acceptance, and change for building-pool interfaces"
status: outline
publication_date: "2025-07-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-03
primary_intent: "Assign interface ownership"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Kawan Kontraktorkolam.co.id"
final_route: "/artikel/interface-register-proyek-kolam.html"
...
# Interface Register: Siapa Mengerjakan Penetrasi, Drainase, dan Power?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Interface Register: Siapa Mengerjakan Penetrasi, Drainase, dan Power?”
- **Reader and situation:** Project with several contractors
- **Reader outcome:** Track each boundary, input, owner, due date, acceptance, and change for building-pool interfaces
- **Primary intent:** Assign interface ownership
...
- **Scope boundary:** Detailed trade checks remain KKP-07–11
- **Final public route:** `/artikel/interface-register-proyek-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Interface Register: Siapa Mengerjakan Penetrasi, Drainase, dan Power?**.
...
- `KKP-03-A06` → `/artikel/kickoff-proyek-kolam.html` — Rapat Kickoff Proyek Kolam: Agenda, Keputusan, dan Baseline
...
- **Tie back to this article:** Keep the explanation specific to “Interface Register: Siapa Mengerjakan Penetrasi, Drainase, dan Power?”.
