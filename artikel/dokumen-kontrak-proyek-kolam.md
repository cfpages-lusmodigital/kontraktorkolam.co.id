---
article_id: KKP-17-A03
title: "Dokumen Kontrak Proyek Kolam: Scope, Harga, Waktu, dan Risiko"
slug: "dokumen-kontrak-proyek-kolam"
description: "Map agreement, scope/drawings/specs/BOQ, precedence, price, payment, time, approvals, changes, safety, QA, handover, warranty, termination"
status: outline
publication_date: "2026-06-18"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-17
primary_intent: "Structure contract review"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Teman Kontraktorkolam.co.id"
final_route: "/artikel/dokumen-kontrak-proyek-kolam.html"
...
# Dokumen Kontrak Proyek Kolam: Scope, Harga, Waktu, dan Risiko

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Dokumen Kontrak Proyek Kolam: Scope, Harga, Waktu, dan Risiko”
- **Reader and situation:** Owner before signing
- **Reader outcome:** Map agreement, scope/drawings/specs/BOQ, precedence, price, payment, time, approvals, changes, safety, QA, handover, warranty, termination
- **Primary intent:** Structure contract review
...
- **Scope boundary:** Not legal advice; qualified counsel/current law required
- **Final public route:** `/artikel/dokumen-kontrak-proyek-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dokumen Kontrak Proyek Kolam: Scope, Harga, Waktu, dan Risiko**.
...
- `KKP-17-A01` → `/artikel/due-diligence-kontraktor-kolam.html` — Due Diligence Kontraktor Kolam sebelum Penunjukan
- `KKP-17-A02` → `/artikel/memeriksa-portofolio-kontraktor-kolam.html` — Cara Memeriksa Portofolio dan Referensi Proyek Kolam
- `KKP-17-A04` → `/artikel/variation-order-proyek-kolam.html` — Variation Order Proyek Kolam: Bukti sebelum Harga dan Waktu Berubah
- `KKP-17-A05` → `/artikel/garansi-defect-liability-kolam.html` — Garansi, Defect Liability, Retention, dan SLA Kontraktor Kolam
...
- **Tie back to this article:** Keep the explanation specific to “Dokumen Kontrak Proyek Kolam: Scope, Harga, Waktu, dan Risiko”.
