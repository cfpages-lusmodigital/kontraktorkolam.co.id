---
article_id: KKP-10-A04
title: "ITP Aplikasi Waterproofing Kolam"
slug: "itp-waterproofing-kolam"
description: "Define batch/material checks, mixing/application records, thickness/coverage evidence, details, coats, curing, protection, and NCRs"
status: outline
publication_date: "2026-01-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-10
primary_intent: "Control installation quality"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Teman Kontraktorkolam.co.id"
final_route: "/artikel/itp-waterproofing-kolam.html"
...
# ITP Aplikasi Waterproofing Kolam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “ITP Aplikasi Waterproofing Kolam”
- **Reader and situation:** Consultant/contractor
- **Reader outcome:** Define batch/material checks, mixing/application records, thickness/coverage evidence, details, coats, curing, protection, and NCRs
- **Primary intent:** Control installation quality
...
- **Scope boundary:** Not an application tutorial or substitute for trained applicator
- **Final public route:** `/artikel/itp-waterproofing-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **ITP Aplikasi Waterproofing Kolam**.
...
- `KKP-10-A05` → `/artikel/flood-test-waterproofing-kolam.html` — Flood Test Kolam: Rencana, Baseline, Observasi, dan Keputusan
- `KKP-10-A06` → `/artikel/perlindungan-waterproofing-kolam.html` — Melindungi Waterproofing dari Pekerjaan Berikutnya
...
- **Tie back to this article:** Keep the explanation specific to “ITP Aplikasi Waterproofing Kolam”.
