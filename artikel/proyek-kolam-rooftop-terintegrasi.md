---
article_id: KKP-18-A05
title: "Kolam Rooftop sebagai Proyek Terintegrasi, Bukan Produk Lepas"
slug: "proyek-kolam-rooftop-terintegrasi"
description: "Connect structural audit, movement, drainage, waterproofing, lifting, plant access, noise, leak consequence, testing, and maintenance"
status: outline
publication_date: "2026-07-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-18
primary_intent: "Understand rooftop interfaces"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Sobat Kontraktorkolam.co.id"
final_route: "/artikel/proyek-kolam-rooftop-terintegrasi.html"
...
# Kolam Rooftop sebagai Proyek Terintegrasi, Bukan Produk Lepas

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kolam Rooftop sebagai Proyek Terintegrasi, Bukan Produk Lepas”
- **Reader and situation:** Developer/architect/owner
- **Reader outcome:** Connect structural audit, movement, drainage, waterproofing, lifting, plant access, noise, leak consequence, testing, and maintenance
- **Primary intent:** Understand rooftop interfaces
...
- **Scope boundary:** Structural design remains KKP-02-A04/07-A06
- **Final public route:** `/artikel/proyek-kolam-rooftop-terintegrasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kolam Rooftop sebagai Proyek Terintegrasi, Bukan Produk Lepas**.
...
- `KKP-18-A03` → `/artikel/proyek-kolam-apartemen.html` — Kolam Apartemen: Interface Developer, Pengelola, dan Penghuni
- `KKP-18-A04` → `/artikel/proyek-kolam-sekolah-publik.html` — Kolam Sekolah, Klub, dan Publik: Bather Load dan Governance
- `KKP-18-A06` → `/artikel/case-study-proyek-kolam-terverifikasi.html` — Menulis Case Study Proyek Kolam yang Bisa Diverifikasi
...
- **Tie back to this article:** Keep the explanation specific to “Kolam Rooftop sebagai Proyek Terintegrasi, Bukan Produk Lepas”.
