---
article_id: KKP-12-A01
title: "Submittal Equipment Kolam: Data yang Harus Dicek"
slug: "submittal-equipment-kolam"
description: "Check duty basis, compatibility, ratings, materials, controls, dimensions, service access, compliance evidence, documents, warranty, and deviations"
status: outline
publication_date: "2026-02-10"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-12
primary_intent: "Review equipment proposals"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Teman Kontraktorkolam.co.id"
final_route: "/artikel/submittal-equipment-kolam.html"
...
# Submittal Equipment Kolam: Data yang Harus Dicek

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Submittal Equipment Kolam: Data yang Harus Dicek”
- **Reader and situation:** Engineer/owner before approval
- **Reader outcome:** Check duty basis, compatibility, ratings, materials, controls, dimensions, service access, compliance evidence, documents, warranty, and deviations
- **Primary intent:** Review equipment proposals
...
- **Scope boundary:** Does not approve capacity or endorse brands
- **Final public route:** `/artikel/submittal-equipment-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Submittal Equipment Kolam: Data yang Harus Dicek**.
...
- `KKP-12-A03` → `/artikel/substitusi-material-proyek-kolam.html` — Menilai Material Alternatif dan Substitusi pada Proyek Kolam
...
- **Tie back to this article:** Keep the explanation specific to “Submittal Equipment Kolam: Data yang Harus Dicek”.
