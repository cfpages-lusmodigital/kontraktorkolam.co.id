---
article_id: KKP-02-A04
title: "Audit Struktur untuk Kolam Rooftop atau Bangunan Eksisting"
slug: "audit-struktur-kolam-rooftop"
description: "Define records, load paths, water/structure/equipment loads, movement, penetrations, access, and engineer deliverables"
status: outline
publication_date: "2025-06-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-02
primary_intent: "Frame structural due diligence"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Kawan Kontraktorkolam.co.id"
final_route: "/artikel/audit-struktur-kolam-rooftop.html"
...
# Audit Struktur untuk Kolam Rooftop atau Bangunan Eksisting

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Audit Struktur untuk Kolam Rooftop atau Bangunan Eksisting”
- **Reader and situation:** Owner adding a pool to a building
- **Reader outcome:** Define records, load paths, water/structure/equipment loads, movement, penetrations, access, and engineer deliverables
- **Primary intent:** Frame structural due diligence
...
- **Scope boundary:** No capacity conclusion without structural engineer
- **Final public route:** `/artikel/audit-struktur-kolam-rooftop.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Audit Struktur untuk Kolam Rooftop atau Bangunan Eksisting**.
...
- **Tie back to this article:** Keep the explanation specific to “Audit Struktur untuk Kolam Rooftop atau Bangunan Eksisting”.
