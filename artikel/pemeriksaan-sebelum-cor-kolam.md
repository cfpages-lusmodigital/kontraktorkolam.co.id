---
article_id: KKP-07-A03
title: "Pemeriksaan Tulangan, Embedment, dan Penetrasi sebelum Pengecoran"
slug: "pemeriksaan-sebelum-cor-kolam"
description: "Coordinate drawings, bar identity/condition, cover system, joints, waterstops, sleeves, drains, lights, cleanliness, and sign-off"
status: outline
publication_date: "2025-10-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-07
primary_intent: "Prevent hidden defects"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Sobat Kontraktorkolam.co.id"
final_route: "/artikel/pemeriksaan-sebelum-cor-kolam.html"
...
# Pemeriksaan Tulangan, Embedment, dan Penetrasi sebelum Pengecoran

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pemeriksaan Tulangan, Embedment, dan Penetrasi sebelum Pengecoran”
- **Reader and situation:** Site team at pre-pour stage
- **Reader outcome:** Coordinate drawings, bar identity/condition, cover system, joints, waterstops, sleeves, drains, lights, cleanliness, and sign-off
- **Primary intent:** Prevent hidden defects
...
- **Scope boundary:** No rebar schedule or field redesign
- **Final public route:** `/artikel/pemeriksaan-sebelum-cor-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pemeriksaan Tulangan, Embedment, dan Penetrasi sebelum Pengecoran**.
...
- `KKP-07-A01` → `/artikel/itp-struktur-kolam.html` — ITP Struktur Kolam: Hold Point dari Set-Out sampai Curing
- `KKP-07-A02` → `/artikel/excavation-shoring-dewatering-kolam.html` — Excavation, Shoring, dan Dewatering: Data Sebelum Metode Kerja
- `KKP-07-A04` → `/artikel/concrete-vs-shotcrete-shell-kolam.html` — Concrete atau Shotcrete untuk Shell Kolam: Kontrol Mutu Pelaksanaan
...
- **Tie back to this article:** Keep the explanation specific to “Pemeriksaan Tulangan, Embedment, dan Penetrasi sebelum Pengecoran”.
