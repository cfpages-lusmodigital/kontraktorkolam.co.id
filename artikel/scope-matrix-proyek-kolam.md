---
article_id: KKP-03-A03
title: "Membuat Scope Matrix agar Pekerjaan Kolam Tidak Terlewat"
slug: "scope-matrix-proyek-kolam"
description: "Map design, permits, civil, MEP, finish, deck, equipment, tests, documents, training, and exclusions"
status: outline
publication_date: "2025-07-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KKP-03
primary_intent: "Prevent scope gaps"
reader_community: "Kontraktorkolam.co.id"
reader_address: "Sobat Kontraktorkolam.co.id"
final_route: "/artikel/scope-matrix-proyek-kolam.html"
...
# Membuat Scope Matrix agar Pekerjaan Kolam Tidak Terlewat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Membuat Scope Matrix agar Pekerjaan Kolam Tidak Terlewat”
- **Reader and situation:** Owner comparing proposals
- **Reader outcome:** Map design, permits, civil, MEP, finish, deck, equipment, tests, documents, training, and exclusions
- **Primary intent:** Prevent scope gaps
...
- **Scope boundary:** BOQ quantities belong to KKP-05
- **Final public route:** `/artikel/scope-matrix-proyek-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Membuat Scope Matrix agar Pekerjaan Kolam Tidak Terlewat**.
...
- `KKP-03-A01` → `/artikel/design-build-vs-design-bid-build-kolam.html` — Design-Build atau Design-Bid-Build untuk Proyek Kolam?
- `KKP-03-A02` → `/artikel/peran-tim-proyek-kolam.html` — Peran Arsitek, Struktur, MEP, dan Kontraktor Kolam
- `KKP-03-A04` → `/artikel/interface-register-proyek-kolam.html` — Interface Register: Siapa Mengerjakan Penetrasi, Drainase, dan Power?
- `KKP-03-A05` → `/artikel/owner-supplied-equipment-kolam.html` — Owner-Supplied Equipment: Hemat atau Memindahkan Risiko?
...
- **Tie back to this article:** Keep the explanation specific to “Membuat Scope Matrix agar Pekerjaan Kolam Tidak Terlewat”.
